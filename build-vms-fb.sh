...
do
	...
	--disk device=disk,path=/dev/$server/hdd1,bus=scsi,cache=none,format=raw \
	--disk device=disk,path=/dev/$server/hdd2,bus=scsi,cache=none,format=raw \
	--disk device=disk,path=/dev/$server/hdd3,bus=scsi,cache=none,format=raw \
